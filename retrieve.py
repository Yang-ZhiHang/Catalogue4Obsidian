...
def _show_files_in_directory(
    ...
    if n == 2:
        ...
        output_file_path = "{}\\Second-Level-Catalogue\\{}.md".format(
            output_dir, directory_path.split("\\")[-1]
        )
    elif n == 3:
        ...
        if not os.path.exists("{}\\Second-Level-Catalogue\\Third-Level-Catalogue"
            ...
            os.mkdir("{}\\Second-Level-Catalogue\\Third-Level-Catalogue\\Forth-Level-Catalogue".format(output_dir))
            ...
            with open(output_file_path, "w", encoding="utf-8") as output_file:
                ...
                for file in os.listdir(directory_path):
                    ...
                    # Continues seeking files in directory
                        ...
                        a = n + 1
                        _show_files_in_directory(file_path, ignore_directories, output_dir, a)
        ...
        with open(output_file_path, "w", encoding="utf-8") as output_file:
            for file in os.listdir(first_level_directory_path):
                ...
                if os.path.isdir(file_path):
                    ...
                    _show_files_in_directory(second_level_directory_path, ignore_directories, output_dir)
...
def generate_catalogue(
    ...
    _show_all_in_dir(first_level_directory_path, ignore_directories, output_dir)
